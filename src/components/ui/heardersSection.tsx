...
export function HearderSection() {
  ...
  return (
    ...
    >
      <meta itemProp="name" content="Kims Hotel Guinée" />
      <meta
        itemProp="description"
        content="Réservez des hôtels et appartements en Guinée avec Kims Hotel – simples, rapides et accessibles."
      />
      <meta itemProp="url" content="https://kimshotel.net" />
      <meta itemProp="image" content={images[currentImage]} />
      <div className="absolute inset-0 bg-black/30"></div>
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white ">
        <div className="p-2 lg:p-0 flex flex-col justify-center items-center">
        ...
        <div className="lg:w-full w-[95%] max-w-3xl bg-white rounded-lg p-4 shadow-lg">
          <Tabs defaultValue="flights" className="w-full">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <Input placeholder="De" className="flex-1 text-slate-700" />
              <Input placeholder="À" className="flex-1 text-slate-700" />
              <Input placeholder="Départ" type="date" className="flex-1 text-slate-700" />
