...
import { ReportReservationByMonth } from "@/app/(action)/hotel.action";
...
export function MonthlyChart({ hotelId }: { hotelId: string }) {
  const [chartData, setChartData] = useState<MonthlyData[]>([]);

  useEffect(() => {
    async function fetchData() {
      const rawData = await ReportReservationByMonth(hotelId);
