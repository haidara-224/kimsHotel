            ...
            <div className="w-full min-h-screen bg-background">
                ...
                <div className="lg:px-8 min-h-screen mt-3">
                    ...
                    <div className="container mx-auto w-full">
                        <h1 className="text-center text-slate-500 cursor-pointer hover:text-slate-400 hover:transition-all text-3xl ">Inscrivez votre Appartement,et commencez à recevoir des clients !</h1>
                        <MultiformStep />
                    </div>
                </div>
            </div>
